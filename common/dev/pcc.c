...
// clang-format off
				...
				{ 0x3000, 0x21, 0x80, 0x00 }, { 0x3001, 0x21, 0x80, 0x00 },
				{ 0x3002, 0x21, 0x80, 0x00 }, { 0x3003, 0x21, 0x80, 0x00 },
				{ 0xE2A4, 0x21, 0x80, 0x02 }, { 0xE2A7, 0x21, 0x80, 0x05 },
				{ 0xE2A8, 0x21, 0x80, 0x06 }, { 0xE2AA, 0x21, 0x80, 0x08 },
				{ 0xE2AB, 0x21, 0x80, 0x09 }, { 0xE2AC, 0x21, 0x80, 0x0A },
				{ 0xE2AE, 0x21, 0x80, 0x0B }, { 0xE2B1, 0x21, 0x80, 0x0C },
				{ 0xE2B2, 0x21, 0x80, 0x0D }, { 0xE2E4, 0x21, 0x80, 0x0E },
				{ 0xE2B3, 0x21, 0x80, 0x0F }, { 0xE2B4, 0x21, 0x80, 0x10 },
				{ 0xE2B5, 0x21, 0x80, 0x11 }, { 0xE2B9, 0x21, 0x80, 0x15 },
				{ 0xE2BA, 0x21, 0x80, 0x16 }, { 0xE2BB, 0x21, 0x80, 0x17 },
				{ 0xE2BD, 0x21, 0x80, 0x19 }, { 0xE2BF, 0x21, 0x80, 0x1A },
				{ 0xE2CB, 0x21, 0x80, 0x1D }, { 0xE2CC, 0x21, 0x80, 0x1E },
				{ 0xE2CD, 0x21, 0x80, 0x1F }, { 0xE320, 0x21, 0x80, 0x20 },
				{ 0xE321, 0x21, 0x80, 0x21 }, { 0xE322, 0x21, 0x80, 0x22 },
				{ 0xE2E5, 0x21, 0x80, 0x2E }, { 0xE2EB, 0x21, 0x80, 0x2F },
				{ 0xE2EC, 0x21, 0x80, 0x30 }, { 0xE2AD, 0x21, 0x80, 0x31 },
				{ 0xE2ED, 0x21, 0x80, 0x32 }, { 0xE30E, 0x21, 0x80, 0x34 },
				{ 0xE2CA, 0x21, 0x80, 0x35 }, { 0xE2EF, 0x21, 0x80, 0x36 },
				{ 0xE2C2, 0x21, 0x80, 0x37 }, { 0xE2C3, 0x21, 0x80, 0x38 },
				{ 0xE2E3, 0x21, 0x80, 0x39 }, { 0xE2C6, 0x21, 0x80, 0x3D },
				{ 0xE310, 0x2A, 0x07, 0x4E } };
// clang-format on
...
void check_ABL_error(uint32_t postcode)
{
	...
	msg->data[3] = ABL_error_code_list[i].general_info; // General Information
	...
	msg->data[12] = ABL_error_code_list[i].err_type; // DIMM Error Type
