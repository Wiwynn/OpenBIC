...
enum pmbus_regs {
	...
	PMBUS_DRMOS_FAULT = 0x80, // MPS MP2971 specific
...
enum PMBUS_STATUS_REG_BIT {
	PMBUS_NO_LISTED_FAULT = BIT(0),
	PMBUS_CML_FAULT = BIT(1),
	PMBUS_TEMPERATURE_WARNING_FAULT = BIT(2),
	PMBUS_UNDER_VOLTAGE_FAULT = BIT(3),
	PMBUS_OVER_CURRENT_FAULT = BIT(4),
	PMBUS_OVER_VOLTAGE_FAULT = BIT(5),
	PMBUS_POWER_OFF_FAULT = BIT(6),
	PMBUS_POWER_GOOD_FAULT = BIT(11),
	PMBUS_MFR_SPECIFIC_FAULT = BIT(12),
	PMBUS_INPUT_VOLTAGE_FAULT = BIT(13),
	PMBUS_OUTPUT_CURRENT_WARNING_FAULT = BIT(14),
	PMBUS_OUTPUT_VOLTAGE_WARNING_FAULT = BIT(15),
};
