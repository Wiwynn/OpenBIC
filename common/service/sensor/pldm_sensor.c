...
int get_pldm_sensor_info_via_sensor_id(uint16_t sensor_id, float *resolution, float *offset,
...
uint8_t get_pldm_sensor_reading_from_cache(uint16_t sensor_id, int *reading,
					   uint8_t *sensor_operational_state)
{
	...
	if (get_pldm_sensor_info_via_sensor_id(sensor_id, &resolution, &offset, &unit_modifier,
