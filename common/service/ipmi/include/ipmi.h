...
enum {
	...
	CMD_APP_SET_ACPI_POWER = 0x06,
	CMD_APP_GET_DEVICE_GUID = 0x08,
	CMD_APP_RESET_WATCHDOG_TIMER = 0x22,
	CMD_APP_SET_WATCHDOG_TIMER = 0x24,
	CMD_APP_GET_WATCHDOG_TIMER = 0x25,
	CMD_APP_GET_BMC_GLOBAL_ENABLES = 0x2f,
	CMD_APP_CLEAR_MESSAGE_FLAGS = 0x30,
	CMD_APP_GET_SYSTEM_GUID = 0x37,
	CMD_APP_GET_CAHNNEL_INFO = 0x42,
...
enum {
	...
	CMD_OEM_GET_HTTP_BOOT_DATA = 0x57,
	CMD_OEM_GET_HTTP_BOOT_ATTR = 0x58,
	CMD_OEM_CRASH_DUMP = 0x70,
	...
	CMD_OEM_GET_CHASSIS_POSITION = 0x7E,
};
...
enum {
	...
	CMD_OEM_1S_INFORM_BMC_TO_CONTROL_POWER = 0xD,
	...
	CMD_OEM_1S_JTAG_TCK_CYCLE = 0x20,
	...
	CMD_OEM_1S_SAFE_WRITE_READ_M2_DATA = 0x36,
	...
	CMD_OEM_1S_SET_DEVICE_ACTIVE = 0x78,
	CMD_OEM_1S_GET_PCIE_RETIMER_TYPE = 0x79,
	...
	CMD_OEM_1S_SET_ADD_DEBUG_SEL_MODE = 0xD2,
	CMD_OEM_1S_DEBUG_GET_HW_SIGNAL = 0XD3,
	CMD_OEM_1S_SEND_MCTP_PLDM_COMMAND = 0XD4,
	CMD_OEM_1S_CLEAR_CMET = 0XD5,
	CMD_OEM_1S_SPI_REGISTER_READ = 0XD6,
	CMD_OEM_1S_RESET_I3C_CONTROLLER = 0xD7,
};
