...
pldm_sensor_info plat_pldm_sensor_adc_monitor_table[] = {
	{
		...
		.update_time = 0,
		{
			...
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.init_args = &max11617_init_args[4],
		},
	},
	{
		{
		...
		.update_time = 0,
		{
			...
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.init_args = &max11617_init_args[5],
		},
	},
	{
		{
		...
		.update_time = 0,
		{
			...
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.init_args = &max11617_init_args[6],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.init_args = &max11617_init_args[1],
		},
	},
	{
		{
		...
		.update_time = 0,
		{
			...
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.init_args = &max11617_init_args[2],
		},
	},
	{
		{
		...
		.update_time = 0,
		{
			...
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.init_args = &max11617_init_args[3],
		},
	},
};
