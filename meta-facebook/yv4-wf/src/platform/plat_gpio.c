...
GPIO_CFG plat_gpio_cfg[] = {
	...
	{ CHIP_GPIO, 11, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_P0V85_ASIC2_POWER_FAULT },
	...
	{ CHIP_GPIO, 17, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_P0V85_ASIC1_POWER_FAULT },
	...
	{ CHIP_GPIO, 23, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_P0V8_ASIC1_POWER_FAULT },
	...
	{ CHIP_GPIO, 33, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_P0V8_ASIC2_POWER_FAULT },
	...
	/** Group F: 40-47 **/
	{ CHIP_GPIO, 40, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_PVDDQ_CD_ASIC2_POWER_FAULT },
	...
	{ CHIP_GPIO, 53, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_PVDDQ_AB_ASIC1_POWER_FAULT },
	{ CHIP_GPIO, 54, ENABLE, ENABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
	{ CHIP_GPIO, 55, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_PVDDQ_CD_ASIC1_POWER_FAULT },
	...
	{ CHIP_GPIO, 94, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_PVDDQ_AB_ASIC2_POWER_FAULT },
