...
struct pldm_descriptor_string PLDM_VR_PVDDQ_AB_ASIC1_DESCRIPTORS[] = {
	...
	},
	{
		...
		.descriptor_data = "PVDDQ_AB_ASIC1",
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
...
struct pldm_descriptor_string PLDM_VR_PVDDQ_CD_ASIC1_DESCRIPTORS[] = {
	...
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
		.title_string = "ComponentInstance",
		.descriptor_data = "PVDDQ_CD_ASIC1",
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
		.title_string = "SlotNumber",
...
struct pldm_descriptor_string PLDM_VR_PVDDQ_AB_ASIC2_DESCRIPTORS[] = {
	...
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
		.title_string = "ComponentInstance",
		.descriptor_data = "PVDDQ_AB_ASIC2",
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
		.title_string = "SlotNumber",
...
struct pldm_descriptor_string PLDM_VR_PVDDQ_CD_ASIC2_DESCRIPTORS[] = {
	...
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
		.title_string = "ComponentInstance",
		.descriptor_data = "PVDDQ_CD_ASIC2",
	},
	{
		.descriptor_type = PLDM_FWUP_VENDOR_DEFINED,
		.title_string = "SlotNumber",
...
struct pldm_descriptor_string PLDM_CXL1_DESCRIPTORS[] = {
	...
	},
	{
		...
		.title_string = NULL,
		.descriptor_data =
			// "com.meta.CXL.1.Vistara_2TV6"
		"636F6D2E6D6574612E43584C2E312E566973746172615F3254563600000000000000000000000000",
	},
};
...
bool replace_slot_number(struct pldm_downstream_identifier_table *downstream_table, size_t idx,
			 uint8_t slot_number)
{
	char **descriptor_data = get_descriptor_data(downstream_table[idx].descriptor,
						     downstream_table[idx].descriptor_count,
...
struct pldm_downstream_identifier_table_and_count get_downstream_identifier_table()
{
	...
	case VR_TYPE_INF:
		...
		break;
	case VR_TYPE_MPS:
		replace_model_number_long_string(d.downstream_table, 0, "com.meta.VR.1.MPS_MP2971");
		replace_model_number_long_string(d.downstream_table, 1, "com.meta.VR.2.MPS_MP2971");
		replace_model_number_long_string(d.downstream_table, 2, "com.meta.VR.3.MPS_MP2971");
		replace_model_number_long_string(d.downstream_table, 3, "com.meta.VR.4.MPS_MP2971");
	...
	default:
		...
		replace_model_number_short_string(d.downstream_table, 3, "");
