...
#endif
		} else if (_2ou_status.present) {
			// disable ipmb and set i2c freq to 100K Hz when DPv2 is present
			i2c_freq_set(pal_IPMB_config_table[EXP2_IPMB_IDX].bus, I2C_SPEED_STANDARD, 0);
