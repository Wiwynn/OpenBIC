...
SDR_Full_sensor plat_sdr_table[] = {
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_VISTARA_TMP75, // sensor number
		...
		0x00, // OEM
		IPMI_SDR_STRING_TYPE_ASCII_8, // ID len, should be same as "size of struct"
		"VISTARA_TMP75_TEMP_C",
	},
	{
		// VISTARA TMP461 CXL TEMP
		0x00,
		0x00, // record ID
		IPMI_SDR_VER_15, // SDR ver
		IPMI_SDR_FULL_SENSOR, // record type
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_VISTARA_CXL, // sensor number
