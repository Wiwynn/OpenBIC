...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_PWR_PVDD11_S3_VR, sensor_dev_raa229621, I2C_BUS5, RAA229621_PVDD11_S3_ADDR,
	  ...
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_vr_read, &vr_pre_read_args[0], NULL,
	  NULL, NULL },
	{ SENSOR_NUM_TEMP_VISTARA_TMP75, sensor_dev_tmp75, I2C_BUS9, VISTARA_TMP75_ADDR,
	  TMP75_TEMP_OFFSET, dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_VISTARA_CXL, sensor_dev_tmp461, I2C_BUS9, VISTARA_CXL_ADDR,
	  TMP461_TEMP_OFFSET, dc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_tmp461_read, NULL, NULL, NULL,
	  &tmp461_init_args[0] },
};
