...
#define IPMI_EVENT_OFFSET_SYS_NE_OPA_PWRGD_P1V8_VR 0x91
#define IPMI_EVENT_OFFSET_SYS_NE_OPA_PWRGD_P0V9_VR 0x92
#define IPMI_EVENT_OFFSET_SYS_NE_OPA_PWRGD_EXP_PWR 0x93
#define IPMI_EVENT_OFFSET_SYS_NE_OPA_CLKBUF_RTM_OE_N 0x94
