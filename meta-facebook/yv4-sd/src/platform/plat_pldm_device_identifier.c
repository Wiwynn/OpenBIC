...
struct pldm_downstream_identifier_table_and_count get_downstream_identifier_table()
{
	...
	case sensor_dev_raa229621:
		replace_model_number_long_string(d.downstream_table, 0, "com.meta.VR.1.RNS_RAA22962x");
		replace_model_number_long_string(d.downstream_table, 1, "com.meta.VR.2.RNS_RAA22962x");
		replace_model_number_long_string(d.downstream_table, 2, "com.meta.VR.3.RNS_RAA22962x");
	...
	case sensor_dev_tps53689:
		replace_model_number_long_string(d.downstream_table, 0, "com.meta.VR.1.TI_TPS536x5");
		replace_model_number_long_string(d.downstream_table, 1, "com.meta.VR.2.TI_TPS536x5");
		replace_model_number_long_string(d.downstream_table, 2, "com.meta.VR.3.TI_TPS536x5");
