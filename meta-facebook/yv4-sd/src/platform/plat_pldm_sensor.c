...
uint8_t plat_pldm_sensor_get_vr_dev(uint8_t *vr_dev)
{
	...
	if (gpio_get(VR_TYPE_1) == HIGH_INACTIVE && gpio_get(VR_TYPE_0) == HIGH_INACTIVE) {
		*vr_dev = sensor_dev_mp2856gut;
	} else if (gpio_get(VR_TYPE_1) == HIGH_INACTIVE && gpio_get(VR_TYPE_0) == HIGH_ACTIVE) {
		*vr_dev = sensor_dev_raa229621;
	} else if (gpio_get(VR_TYPE_1) == HIGH_ACTIVE && gpio_get(VR_TYPE_0) == HIGH_INACTIVE) {
		*vr_dev = sensor_dev_xdpe19283b;
	} else if (gpio_get(VR_TYPE_1) == HIGH_ACTIVE && gpio_get(VR_TYPE_0) == HIGH_ACTIVE) {
		*vr_dev = sensor_dev_tps53689;
	} else {
		LOG_DBG("GPIO VR_TYPE_0:%d VR_TYPE_1:%d", gpio_get(VR_TYPE_0), gpio_get(VR_TYPE_1));
