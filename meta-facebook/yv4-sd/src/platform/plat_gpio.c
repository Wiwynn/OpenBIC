...
GPIO_CFG plat_gpio_cfg[] = {
	...
	{ CHIP_GPIO, 36, ENABLE, DISABLE, GPIO_INPUT, GPIO_HIGH, OPEN_DRAIN, GPIO_INT_DISABLE, ISR_PVDDCR_CPU0_OCP },
	{ CHIP_GPIO, 37, ENABLE, DISABLE, GPIO_INPUT, GPIO_HIGH, OPEN_DRAIN, GPIO_INT_DISABLE, ISR_PVDDCR_CPU1_OCP },
