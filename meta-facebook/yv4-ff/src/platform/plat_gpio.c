...
GPIO_CFG plat_gpio_cfg[] = {
    ...
    { CHIP_GPIO, 6, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, ISR_CXL_PG_ON },
    { CHIP_GPIO, 7, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, OPEN_DRAIN, GPIO_INT_EDGE_BOTH, ISR_MB_DC_STAGUS_CHAGNE },
    ...
    { CHIP_GPIO, 38, DISABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
    { CHIP_GPIO, 39, DISABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
    ...
    { CHIP_GPIO, 95, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_HIGH, PUSH_PULL, GPIO_INT_DISABLE, NULL },

    /** Group M: 96-103 **/
    { CHIP_GPIO, 96, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_HIGH, PUSH_PULL, GPIO_INT_DISABLE, NULL },
    ...
    { CHIP_GPIO, 129, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
