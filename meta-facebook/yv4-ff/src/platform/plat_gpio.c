...
GPIO_CFG plat_gpio_cfg[] = {
    ...
    { CHIP_GPIO, 6, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_EDGE_RISING, ISR_CXL_PG_ON },
    ...
    { CHIP_GPIO, 37, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
