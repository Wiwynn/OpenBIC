...
#define name_gpioM                                                                                 \
	gpio_name_to_num(FM_SPI_MUX_OE_CTL_R_N) gpio_name_to_num(BOARD_ID2) gpio_name_to_num(BOARD_ID3) \
		gpio_name_to_num(LED_CXL_POWER_R) gpio_name_to_num(LED_CXL_FAULT)                  \
