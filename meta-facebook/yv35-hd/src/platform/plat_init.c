...
void pal_pre_init()
{
	...
	if (_1ou_status.present &&
		(_1ou_status.card_type == TYPE_1OU_EXP_WITH_E1S)) {
		// Initialize I3C HUB (HD BIC connects to Olympic2 expension-A and B)
		if (!rg3mxxb12_i2c_mode_only_init(I2C_BUS8, BIT(2))) {
