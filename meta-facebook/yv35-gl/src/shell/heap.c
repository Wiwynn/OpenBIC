...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_heap,
	SHELL_CMD(system, NULL, "Show system::k_malloc heap statistic", cmd_system),
	SHELL_CMD(libc, NULL, "Show libc::malloc heap statistic", cmd_libc),
