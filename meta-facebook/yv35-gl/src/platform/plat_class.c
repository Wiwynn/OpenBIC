...
void init_i3c_hub_type(void)
{
	...
	if (rg3mxxb12_get_device_info(I2C_BUS8, &exp_1ou_i3c_hub_type) &&
		...
		printk("Expansion 1OU I3C hub type: rg3mxxb12\n");
		...
		printk("Expansion 1OU I3C hub type: p3h284x\n");
	} else {
	...
	if (rg3mxxb12_get_device_info(I2C_BUS9, &exp_2ou_i3c_hub_type) &&
		...
		printk("Expansion 3OU I3C hub type: rg3mxxb12\n");
		...
		printk("Expansion 3OU I3C hub type: p3h284x\n");
	} else {
