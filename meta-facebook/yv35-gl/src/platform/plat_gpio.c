...
GPIO_CFG plat_gpio_cfg[] = {
	...
	{ CHIP_GPIO, 47, DISABLE, DISABLE, GPIO_OUTPUT, GPIO_HIGH, OPEN_DRAIN, GPIO_INT_DISABLE, NULL },
	...
	{ CHIP_GPIO, 100, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, OPEN_DRAIN, GPIO_INT_DISABLE, NULL },
