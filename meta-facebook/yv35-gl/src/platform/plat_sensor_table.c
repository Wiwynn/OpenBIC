...
sensor_cfg plat_sensor_config[] = {
    ...
    */
	...
	{ SENSOR_NUM_MB_DIMMA0_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  ...
	  NULL },
	{ SENSOR_NUM_MB_DIMMA1_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_TEMP_CHANNEL1_DIMM0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_DIMMA2_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_TEMP_CHANNEL2_DIMM0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_DIMMA3_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_TEMP_CHANNEL3_DIMM0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_DIMMA4_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_TEMP_CHANNEL4_DIMM0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_DIMMA5_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_TEMP_CHANNEL5_DIMM0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_DIMMA6_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_TEMP_CHANNEL6_DIMM0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_DIMMA7_TEMP_C, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	...
	// DIMM PMIC power
	{ SENSOR_NUM_MB_VR_DIMMA0_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL0_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA1_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL1_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA2_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL2_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA3_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL3_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA4_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL4_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA5_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL5_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA6_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL6_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_MB_VR_DIMMA7_PMIC_PWR_W, sensor_dev_intel_peci, NONE, CPU_PECI_ADDR,
	  PECI_POWER_CHANNEL7_PMIC0, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_peci_dimm_read, NULL, NULL, NULL,
	  NULL },
