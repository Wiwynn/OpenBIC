...
sensor_cfg plat_sensor_config[] = {
    ...
    */
	...
	{ SENSOR_NUM_MB_DIMMA0_TEMP_C, sensor_dev_i3c_dimm, I3C_BUS4, DIMM_SPD_A0_A4_ADDR,
	  ...
	  DISABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_dimm_i3c_read, NULL,
	...
	{ SENSOR_NUM_MB_VR_DIMMA0_PMIC_PWR_W, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A0_A4_ADDR,
	  ...
	  DISABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_intel_dimm_i3c_read, NULL, NULL, NULL,
	  NULL },
