...
sensor_cfg ltc4282_sensor_config_table[] = {
	...
	{ SENSOR_NUM_TEMP_HSC, sensor_dev_ltc4282, I2C_BUS2, ADI_LTC4282_ADDR,
	  PMBUS_READ_TEMPERATURE_1, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, NULL, NULL, &ltc4282_init_args[0] },
	{ SENSOR_NUM_VOL_HSCIN, sensor_dev_ltc4282, I2C_BUS2, ADI_LTC4282_ADDR, LTC4282_VSOURCE_OFFSET,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &ltc4282_init_args[0] },
	{ SENSOR_NUM_CUR_HSCOUT, sensor_dev_ltc4282, I2C_BUS2, ADI_LTC4282_ADDR, LTC4282_VSENSE_OFFSET,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, post_ltc4282_read, NULL,
	  &ltc4282_init_args[0] },
	{ SENSOR_NUM_PWR_HSCIN, sensor_dev_ltc4282, I2C_BUS2, ADI_LTC4282_ADDR, LTC4282_POWER_OFFSET,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, post_ltc4282_read, NULL,
	  &ltc4282_init_args[0] },
};
	...
	if (get_system_class() == SYS_CLASS_1) {
		...
		case SYS_BOARD_EVT3_HOTSWAP:
			...
			if ((voltage_hsc_type_adc > 0.5 - (0.5 * 0.15)) &&
				...
				printf("Added LTC4282 sensor configuration\n");
				sensor_count = ARRAY_SIZE(ltc4282_sensor_config_table);
				for (int index = 0; index < sensor_count; index++) {
