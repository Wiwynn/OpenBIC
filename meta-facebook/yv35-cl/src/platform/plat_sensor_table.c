...
sensor_cfg fix_class2_sensor_config_table[] = {
	/* number,                  type,       port,      address,      offset,
	   access check arg0, arg1, cache, cache_status, mux_ADDRess, mux_offset,
	   pre_sensor_read_fn, pre_sensor_read_args, post_sensor_read_fn, post_sensor_read_fn  */
};

sensor_cfg fix_1ou_sensor_config_table[] = {
	/* number,                  type,       port,      address,      offset,
	   access check arg0, arg1, cache, cache_status, mux_ADDRess, mux_offset,
	   pre_sensor_read_fn, pre_sensor_read_args, post_sensor_read_fn, post_sensor_read_fn  */
};

sensor_cfg fix_dvp_sensor_config_table[] = {
	/* number,                  type,       port,      address,      offset,
	   access check arg0, arg1, cache, cache_status, mux_ADDRess, mux_offset,
	   pre_sensor_read_fn, pre_sensor_read_args, post_sensor_read_fn, post_sensor_read_fn  */
};
...
void pal_fix_sensor_config()
{
	...
	if (get_bic_class()) {
		fix_sensor_config_num = sizeof(fix_class2_sensor_config_table) / sizeof(sensor_cfg);
	...
	if (get_1ou_status()) {
		fix_sensor_config_num = sizeof(fix_1ou_sensor_config_table) / sizeof(sensor_cfg);
		while (fix_sensor_config_num) {
	...
	if (get_2ou_status()) {
		fix_sensor_config_num = sizeof(fix_dvp_sensor_config_table) / sizeof(sensor_cfg);
		while (fix_sensor_config_num) {
