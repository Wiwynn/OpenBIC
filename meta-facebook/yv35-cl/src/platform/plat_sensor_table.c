...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_PWR_DIMMA_PMIC, sensor_dev_pmic, I2C_BUS3, PCH_ADDR, NONE, me_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_pmic_read, NULL, NULL, NULL, &pmic_init_args[0] },
	{ SENSOR_NUM_PWR_DIMMC_PMIC, sensor_dev_pmic, I2C_BUS3, PCH_ADDR, NONE, me_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_pmic_read, NULL, NULL, NULL, &pmic_init_args[1] },
	{ SENSOR_NUM_PWR_DIMMD_PMIC, sensor_dev_pmic, I2C_BUS3, PCH_ADDR, NONE, me_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_pmic_read, NULL, NULL, NULL, &pmic_init_args[2] },
	{ SENSOR_NUM_PWR_DIMME_PMIC, sensor_dev_pmic, I2C_BUS3, PCH_ADDR, NONE, me_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_pmic_read, NULL, NULL, NULL, &pmic_init_args[3] },
	{ SENSOR_NUM_PWR_DIMMG_PMIC, sensor_dev_pmic, I2C_BUS3, PCH_ADDR, NONE, me_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_pmic_read, NULL, NULL, NULL, &pmic_init_args[4] },
	{ SENSOR_NUM_PWR_DIMMH_PMIC, sensor_dev_pmic, I2C_BUS3, PCH_ADDR, NONE, me_access, 0, 0, 0,
	  SENSOR_INIT_STATUS, pre_pmic_read, NULL, NULL, NULL, &pmic_init_args[5] },
};
