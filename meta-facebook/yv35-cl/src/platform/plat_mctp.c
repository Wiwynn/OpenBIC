...
/* i3c 7-bit addr */
#define I3C_DYNAMIC_ADDR_BMC	0x20
#define I3C_STATIC_ADDR_BIC		0x09
#define I3C_DYNAMIC_ADDR_BIC	0x10
...
static mctp_i3c_port i3c_port[] = {
	{ .conf.i3c_conf.bus = I3C_BUS_BMC, .conf.i3c_conf.addr = I3C_DYNAMIC_ADDR_BMC},
};

mctp_route_entry mctp_route_tbl[] = {
	{ MCTP_EID_BMC, I3C_BUS_BMC, I3C_DYNAMIC_ADDR_BMC },
...
static void set_dev_endpoint(void)
{
	for (uint8_t i = 0; i < ARRAY_SIZE(mctp_route_tbl); i++) {
		...
		/* skip BMC */
		if (p->bus == I3C_BUS_BMC && p->addr == I3C_DYNAMIC_ADDR_BMC)
			continue;
