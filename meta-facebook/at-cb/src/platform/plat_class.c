...
int init_platform_config()
{
	...
	board_revision = gpio_pin_get(gpio_dev, (BOARD_REV_0_PIN_NUM % GPIO_GROUP_SIZE));
	board_revision |= gpio_pin_get(gpio_dev, (BOARD_REV_1_PIN_NUM % GPIO_GROUP_SIZE)) << 1;
	board_revision |= gpio_pin_get(gpio_dev, (BOARD_REV_2_PIN_NUM % GPIO_GROUP_SIZE)) << 2;
