...
extern const uint8_t cpld_descriptors_count;
extern const uint8_t vr_xdpe15284_descriptors_count;
...
extern struct pldm_descriptor_string CPLD_DESCRIPTOR_TABLE[];
extern struct pldm_descriptor_string VR_XDPE15284_DESCRIPTOR_TABLE[];
