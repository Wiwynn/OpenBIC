...
void OEM_1S_GET_CXL_RESET_COUNT(ipmi_msg *msg)
{
   ...
   *   	2h: Get pe-reset flag
	...
	case CXL_GET_PE_RESET_FLAG:
		msg->data_len = 8;
		msg->data[0] = cxl_work_item[6].is_pe_reset;
		msg->data[1] = cxl_work_item[7].is_pe_reset;
		msg->data[2] = cxl_work_item[4].is_pe_reset;
		msg->data[3] = cxl_work_item[5].is_pe_reset;
		msg->data[4] = cxl_work_item[3].is_pe_reset;
		msg->data[5] = cxl_work_item[2].is_pe_reset;
		msg->data[6] = cxl_work_item[1].is_pe_reset;
		msg->data[7] = cxl_work_item[0].is_pe_reset;
		break;
	default:
		msg->completion_code = CC_INVALID_PARAM;
		return;
