...
sensor_cfg cxl1_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[0], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[1], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[0], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[1], &cxl_mux_configs[1] },
	{ SENSOR_NUM_PWR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_PWR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[0], &cxl_mux_configs[1] },
	{ SENSOR_NUM_PWR_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_PWR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[1], &cxl_mux_configs[1] },

	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P12V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_0_READING_REG, stby_access, 66, 10, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P3V3_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_1_READING_REG, stby_access, 2, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_PVPP_AB, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_3_READING_REG, stby_access, 2, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_PVTT_AB, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_6_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_PVPP_CD, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_5_READING_REG, stby_access, 2, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_PVTT_CD, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_7_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[0], &cxl_mux_configs[5] },
};

sensor_cfg cxl2_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[2], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[3], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[2], &cxl_mux_configs[1] },
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[1], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[1], &cxl_mux_configs[5] },
...
sensor_cfg cxl3_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[4], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[5], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[4], &cxl_mux_configs[1] },
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[2], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[2], &cxl_mux_configs[5] },
...
sensor_cfg cxl4_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[6], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[7], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[6], &cxl_mux_configs[1] },
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[3], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[3], &cxl_mux_configs[5] },
...
sensor_cfg cxl5_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[8], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[9], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[8], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SENSOR_NUM_CUR_P12V_STBY_4CP, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[9], &cxl_mux_configs[1] },
	{ SENSOR_NUM_PWR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_PWR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[4], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[4], &cxl_mux_configs[5] },
...
sensor_cfg cxl6_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[10], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[11], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[10], &cxl_mux_configs[1] },
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[5], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[5], &cxl_mux_configs[5] },
...
sensor_cfg cxl7_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[12], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[13], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[12], &cxl_mux_configs[1] },
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[6], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[6], &cxl_mux_configs[5] },
...
sensor_cfg cxl8_ee_2nd_source_sensor_config[] = {
	{ SENSOR_NUM_VOL_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[14], &cxl_mux_configs[1] },
	{ SENSOR_NUM_VOL_P3V3_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U7_INA233_ADDR,
	  SQ52205_READ_VOL_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[15], &cxl_mux_configs[1] },
	{ SENSOR_NUM_CUR_P12V_STBY_4CP, sensor_dev_sq52205, I2C_BUS2, CXL_U6_INA233_ADDR,
	  SQ52205_READ_CUR_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_sq52205_init_args[14], &cxl_mux_configs[1] },
	...
	{ SENSOR_NUM_VOL_P5V_STBY, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_2_READING_REG, stby_access, 711, 200, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[7], &cxl_mux_configs[5] },
	{ SENSOR_NUM_VOL_P1V8_ASIC, sensor_dev_adc128, I2C_BUS2, CXL_U3_ADC128_ADDR,
	  ADC128_CHANNEL_4_READING_REG, stby_access, 1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &cxl_adc128_init_args[7], &cxl_mux_configs[5] },
...
void plat_fill_monitor_sensor_table()
{
	...
	for (cxl_id = 0; cxl_id < CXL_CARD_MAX; ++cxl_id) {
		if (get_cxl_ee_source(cxl_id) == CXL_EE_SECOND_SOURCE) {
			sensor_cfg *cfg_table = get_cxl_2nd_source_sensor_cfg(cxl_id);
			if (cfg_table == NULL) {
				LOG_ERR("Fail to get CXL 2nd source sensor table, cxl id: 0x%x",
					cxl_id);
				continue;
			}

			for (index = 0; index < ARRAY_SIZE(cxl1_ee_2nd_source_sensor_config);
			     ++index) {
				sensor_cfg *cfg = find_sensor_cfg_via_sensor_num(
					plat_monitor_table[cxl_id].monitor_sensor_cfg,
					plat_monitor_table[cxl_id].cfg_count, cfg_table[index].num);
				if (cfg == NULL) {
					LOG_ERR("Fail to CXL 2nd source sensor cfg, cxl id: 0x%x, sensor num: 0x%x",
						cxl_id, cfg_table[index].num);
					continue;
				}

				memcpy(cfg, &cfg_table[index], sizeof(sensor_cfg));
			}
		}
	}
...
sensor_cfg *get_cxl_2nd_source_sensor_cfg(uint8_t cxl_id)
{
	switch (cxl_id) {
	case CXL_CARD_1:
		return cxl1_ee_2nd_source_sensor_config;
	case CXL_CARD_2:
		return cxl2_ee_2nd_source_sensor_config;
	case CXL_CARD_3:
		return cxl3_ee_2nd_source_sensor_config;
	case CXL_CARD_4:
		return cxl4_ee_2nd_source_sensor_config;
	case CXL_CARD_5:
		return cxl5_ee_2nd_source_sensor_config;
	case CXL_CARD_6:
		return cxl6_ee_2nd_source_sensor_config;
	case CXL_CARD_7:
		return cxl7_ee_2nd_source_sensor_config;
	case CXL_CARD_8:
		return cxl8_ee_2nd_source_sensor_config;
	default:
		return NULL;
	}
}
