...
#define update_name_gpioG \
  gpio_name_to_num(CXL_HB_CARD6) \
  gpio_name_to_num(CXL_HB_CARD8) \
  gpio_name_to_num(CXL_HB_CARD3) \
  gpio_name_to_num(CXL_HB_CARD4) \
  gpio_name_to_num(CXL_HB_CARD5) \
  gpio_name_to_num(CXL_HB_CARD7) \
  gpio_name_to_num(CXL_HB_CARD1) \
  gpio_name_to_num(CXL_HB_CARD2)
