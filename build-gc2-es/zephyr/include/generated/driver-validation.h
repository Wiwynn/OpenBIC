...
#define Z_SYSCALL_DRIVER_ECDSA(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, ecdsa, ECDSA)

#define Z_SYSCALL_DRIVER_HASH(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, hash, HASH)

#define Z_SYSCALL_DRIVER_RSA(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, rsa, RSA)
...
#define Z_SYSCALL_DRIVER_EC_HOST_CMD_PERIPH_API(ptr, op)                                           \
	Z_SYSCALL_DRIVER_GEN(ptr, op, ec_host_cmd_periph_api, EC_HOST_CMD_PERIPH_API)
...
#define Z_SYSCALL_DRIVER_JTAG(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, jtag, JTAG)
...
#define Z_SYSCALL_DRIVER_OTP(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, otp, OTP)
