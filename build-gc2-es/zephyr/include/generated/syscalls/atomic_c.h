...
static inline bool atomic_cas(atomic_t *target, atomic_val_t old_value, atomic_val_t new_value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (bool)arch_syscall_invoke3(*(uintptr_t *)&target, *(uintptr_t *)&old_value,
						  *(uintptr_t *)&new_value, K_SYSCALL_ATOMIC_CAS);
	}
#endif
	compiler_barrier();
...
extern bool z_impl_atomic_ptr_cas(atomic_ptr_t *target, atomic_ptr_val_t old_value,
...
static inline atomic_val_t atomic_add(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_ADD);
	}
#endif
	compiler_barrier();
...
static inline atomic_val_t atomic_sub(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_SUB);
	}
#endif
	compiler_barrier();
...
static inline atomic_val_t atomic_set(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_SET);
	}
#endif
	compiler_barrier();
...
static inline atomic_ptr_val_t atomic_ptr_set(atomic_ptr_t *target, atomic_ptr_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_ptr_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_PTR_SET);
	}
#endif
	compiler_barrier();
...
static inline atomic_val_t atomic_or(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_OR);
	}
#endif
	compiler_barrier();
...
static inline atomic_val_t atomic_xor(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_XOR);
	}
#endif
	compiler_barrier();
...
static inline atomic_val_t atomic_and(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_AND);
	}
#endif
	compiler_barrier();
...
static inline atomic_val_t atomic_nand(atomic_t *target, atomic_val_t value)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (atomic_val_t)arch_syscall_invoke2(
			*(uintptr_t *)&target, *(uintptr_t *)&value, K_SYSCALL_ATOMIC_NAND);
	}
#endif
	compiler_barrier();
