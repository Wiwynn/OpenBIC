...
extern k_tid_t z_impl_k_thread_create(struct k_thread *new_thread, k_thread_stack_t *stack,
				      size_t stack_size, k_thread_entry_t entry, void *p1, void *p2,
				      void *p3, int prio, uint32_t options, k_timeout_t delay);
static inline k_tid_t k_thread_create(struct k_thread *new_thread, k_thread_stack_t *stack,
				      size_t stack_size, k_thread_entry_t entry, void *p1, void *p2,
				      void *p3, int prio, uint32_t options, k_timeout_t delay)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = delay;
		uintptr_t more[] = { *(uintptr_t *)&p2,	     *(uintptr_t *)&p3, *(uintptr_t *)&prio,
				     *(uintptr_t *)&options, parm0.split.lo,	parm0.split.hi };
		/* coverity[OVERRUN] */
		return (k_tid_t)arch_syscall_invoke6(*(uintptr_t *)&new_thread,
						     *(uintptr_t *)&stack,
						     *(uintptr_t *)&stack_size,
						     *(uintptr_t *)&entry, *(uintptr_t *)&p1,
						     (uintptr_t)&more, K_SYSCALL_K_THREAD_CREATE);
	}
#endif
	compiler_barrier();
	return z_impl_k_thread_create(new_thread, stack, stack_size, entry, p1, p2, p3, prio,
				      options, delay);
}
...
static inline int k_thread_stack_space_get(const struct k_thread *thread, size_t *unused_ptr)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&thread, *(uintptr_t *)&unused_ptr,
						 K_SYSCALL_K_THREAD_STACK_SPACE_GET);
	}
#endif
	compiler_barrier();
...
static inline int k_thread_join(struct k_thread *thread, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&thread, parm0.split.lo,
						 parm0.split.hi, K_SYSCALL_K_THREAD_JOIN);
	}
#endif
	compiler_barrier();
...
static inline int32_t k_sleep(k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int32_t)arch_syscall_invoke2(parm0.split.lo, parm0.split.hi,
						     K_SYSCALL_K_SLEEP);
	}
#endif
	compiler_barrier();
...
static inline k_ticks_t k_thread_timeout_expires_ticks(const struct k_thread *t)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (k_ticks_t)arch_syscall_invoke1(*(uintptr_t *)&t,
...
static inline k_ticks_t k_thread_timeout_remaining_ticks(const struct k_thread *t)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (k_ticks_t)arch_syscall_invoke1(*(uintptr_t *)&t,
						       K_SYSCALL_K_THREAD_TIMEOUT_REMAINING_TICKS);
	}
#endif
	compiler_barrier();
...
static inline int k_thread_priority_get(k_tid_t thread)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke1(*(uintptr_t *)&thread,
...
static inline void k_thread_priority_set(k_tid_t thread, int prio)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		arch_syscall_invoke2(*(uintptr_t *)&thread, *(uintptr_t *)&prio,
...
static inline void k_thread_deadline_set(k_tid_t thread, int deadline)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		arch_syscall_invoke2(*(uintptr_t *)&thread, *(uintptr_t *)&deadline,
...
static inline int k_thread_name_set(k_tid_t thread, const char *str)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&thread, *(uintptr_t *)&str,
						 K_SYSCALL_K_THREAD_NAME_SET);
	}
#endif
	compiler_barrier();
...
static inline int k_thread_name_copy(k_tid_t thread, char *buf, size_t size)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&thread, *(uintptr_t *)&buf,
						 *(uintptr_t *)&size, K_SYSCALL_K_THREAD_NAME_COPY);
	}
#endif
	compiler_barrier();
...
static inline void k_timer_start(struct k_timer *timer, k_timeout_t duration, k_timeout_t period)
{
	...
	if (z_syscall_trap()) {
		...
		parm1.val = period;
		/* coverity[OVERRUN] */
		arch_syscall_invoke5(*(uintptr_t *)&timer, parm0.split.lo, parm0.split.hi,
				     parm1.split.lo, parm1.split.hi, K_SYSCALL_K_TIMER_START);
		return;
	}
#endif
	compiler_barrier();
...
static inline uint32_t k_timer_status_get(struct k_timer *timer)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (uint32_t)arch_syscall_invoke1(*(uintptr_t *)&timer,
...
static inline k_ticks_t k_timer_expires_ticks(const struct k_timer *timer)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (k_ticks_t)arch_syscall_invoke1(*(uintptr_t *)&timer,
						       K_SYSCALL_K_TIMER_EXPIRES_TICKS);
	}
#endif
	compiler_barrier();
...
static inline k_ticks_t k_timer_remaining_ticks(const struct k_timer *timer)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (k_ticks_t)arch_syscall_invoke1(*(uintptr_t *)&timer,
						       K_SYSCALL_K_TIMER_REMAINING_TICKS);
	}
#endif
	compiler_barrier();
...
static inline void k_timer_user_data_set(struct k_timer *timer, void *user_data)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		arch_syscall_invoke2(*(uintptr_t *)&timer, *(uintptr_t *)&user_data,
...
static inline void *k_timer_user_data_get(const struct k_timer *timer)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (void *)arch_syscall_invoke1(*(uintptr_t *)&timer,
...
static inline int32_t k_queue_alloc_append(struct k_queue *queue, void *data)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int32_t)arch_syscall_invoke2(*(uintptr_t *)&queue, *(uintptr_t *)&data,
...
static inline void *k_queue_get(struct k_queue *queue, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (void *)arch_syscall_invoke3(*(uintptr_t *)&queue, parm0.split.lo,
						    parm0.split.hi, K_SYSCALL_K_QUEUE_GET);
	}
#endif
	compiler_barrier();
...
static inline void *k_queue_peek_head(struct k_queue *queue)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (void *)arch_syscall_invoke1(*(uintptr_t *)&queue,
...
static inline int k_futex_wake(struct k_futex *futex, bool wake_all)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&futex, *(uintptr_t *)&wake_all,
						 K_SYSCALL_K_FUTEX_WAKE);
	}
#endif
	compiler_barrier();
...
static inline int32_t k_stack_alloc_init(struct k_stack *stack, uint32_t num_entries)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int32_t)arch_syscall_invoke2(*(uintptr_t *)&stack,
...
static inline int k_stack_push(struct k_stack *stack, stack_data_t data)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&stack, *(uintptr_t *)&data,
...
static inline int k_stack_pop(struct k_stack *stack, stack_data_t *data, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke4(*(uintptr_t *)&stack, *(uintptr_t *)&data,
						 parm0.split.lo, parm0.split.hi,
...
static inline int k_mutex_lock(struct k_mutex *mutex, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&mutex, parm0.split.lo,
						 parm0.split.hi, K_SYSCALL_K_MUTEX_LOCK);
	}
#endif
	compiler_barrier();
...
static inline int k_condvar_signal(struct k_condvar *condvar)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke1(*(uintptr_t *)&condvar,
...
extern int z_impl_k_condvar_wait(struct k_condvar *condvar, struct k_mutex *mutex,
				 k_timeout_t timeout);
				 ...
				 k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke4(*(uintptr_t *)&condvar, *(uintptr_t *)&mutex,
						 parm0.split.lo, parm0.split.hi,
						 K_SYSCALL_K_CONDVAR_WAIT);
	}
#endif
	compiler_barrier();
...
static inline int k_sem_init(struct k_sem *sem, unsigned int initial_count, unsigned int limit)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&sem, *(uintptr_t *)&initial_count,
...
static inline int k_sem_take(struct k_sem *sem, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&sem, parm0.split.lo, parm0.split.hi,
...
static inline unsigned int k_sem_count_get(struct k_sem *sem)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (unsigned int)arch_syscall_invoke1(*(uintptr_t *)&sem,
...
static inline int k_msgq_alloc_init(struct k_msgq *msgq, size_t msg_size, uint32_t max_msgs)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&msgq, *(uintptr_t *)&msg_size,
						 *(uintptr_t *)&max_msgs,
...
static inline int k_msgq_put(struct k_msgq *msgq, const void *data, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke4(*(uintptr_t *)&msgq, *(uintptr_t *)&data,
						 parm0.split.lo, parm0.split.hi,
...
static inline int k_msgq_peek(struct k_msgq *msgq, void *data)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&msgq, *(uintptr_t *)&data,
						 K_SYSCALL_K_MSGQ_PEEK);
	}
#endif
	compiler_barrier();
...
static inline uint32_t k_msgq_num_free_get(struct k_msgq *msgq)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (uint32_t)arch_syscall_invoke1(*(uintptr_t *)&msgq,
...
static inline void k_msgq_get_attrs(struct k_msgq *msgq, struct k_msgq_attrs *attrs)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		arch_syscall_invoke2(*(uintptr_t *)&msgq, *(uintptr_t *)&attrs,
...
static inline int k_pipe_alloc_init(struct k_pipe *pipe, size_t size)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&pipe, *(uintptr_t *)&size,
...
extern int z_impl_k_pipe_put(struct k_pipe *pipe, void *data, size_t bytes_to_write,
			     size_t *bytes_written, size_t min_xfer, k_timeout_t timeout);
static inline int k_pipe_put(struct k_pipe *pipe, void *data, size_t bytes_to_write,
			     size_t *bytes_written, size_t min_xfer, k_timeout_t timeout)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		uintptr_t more[] = { parm0.split.lo, parm0.split.hi };
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke6(*(uintptr_t *)&pipe, *(uintptr_t *)&data,
						 *(uintptr_t *)&bytes_to_write,
						 *(uintptr_t *)&bytes_written,
						 *(uintptr_t *)&min_xfer, (uintptr_t)&more,
...
extern int z_impl_k_pipe_get(struct k_pipe *pipe, void *data, size_t bytes_to_read,
			     size_t *bytes_read, size_t min_xfer, k_timeout_t timeout);
static inline int k_pipe_get(struct k_pipe *pipe, void *data, size_t bytes_to_read,
			     size_t *bytes_read, size_t min_xfer, k_timeout_t timeout)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		...
		return (int)arch_syscall_invoke6(*(uintptr_t *)&pipe, *(uintptr_t *)&data,
						 ...
						 *(uintptr_t *)&bytes_read, *(uintptr_t *)&min_xfer,
						 (uintptr_t)&more, K_SYSCALL_K_PIPE_GET);
	}
#endif
	compiler_barrier();
...
static inline size_t k_pipe_read_avail(struct k_pipe *pipe)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (size_t)arch_syscall_invoke1(*(uintptr_t *)&pipe,
						    K_SYSCALL_K_PIPE_READ_AVAIL);
	}
#endif
	compiler_barrier();
...
static inline int k_poll(struct k_poll_event *events, int num_events, k_timeout_t timeout)
{
	...
	if (z_syscall_trap()) {
		...
		parm0.val = timeout;
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke4(*(uintptr_t *)&events, *(uintptr_t *)&num_events,
						 parm0.split.lo, parm0.split.hi, K_SYSCALL_K_POLL);
	}
#endif
	compiler_barrier();
...
extern void z_impl_k_poll_signal_check(struct k_poll_signal *sig, unsigned int *signaled,
				       int *result);
static inline void k_poll_signal_check(struct k_poll_signal *sig, unsigned int *signaled,
				       int *result)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		arch_syscall_invoke3(*(uintptr_t *)&sig, *(uintptr_t *)&signaled,
				     *(uintptr_t *)&result, K_SYSCALL_K_POLL_SIGNAL_CHECK);
		return;
	}
#endif
	compiler_barrier();
...
static inline int k_poll_signal_raise(struct k_poll_signal *sig, int result)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&sig, *(uintptr_t *)&result,
						 K_SYSCALL_K_POLL_SIGNAL_RAISE);
	}
#endif
	compiler_barrier();
...
static inline int k_float_enable(struct k_thread *thread, unsigned int options)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&thread, *(uintptr_t *)&options,
						 K_SYSCALL_K_FLOAT_ENABLE);
	}
#endif
	compiler_barrier();
