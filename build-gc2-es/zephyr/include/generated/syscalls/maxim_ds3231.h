...
extern int z_impl_maxim_ds3231_req_syncpoint(const struct device *dev,
...
static inline int maxim_ds3231_req_syncpoint(const struct device *dev, struct k_poll_signal *signal)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&dev, *(uintptr_t *)&signal,
...
extern int z_impl_maxim_ds3231_get_syncpoint(const struct device *dev,
					     struct maxim_ds3231_syncpoint *syncpoint);
static inline int maxim_ds3231_get_syncpoint(const struct device *dev,
					     struct maxim_ds3231_syncpoint *syncpoint)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&dev, *(uintptr_t *)&syncpoint,
