...
static inline int net_if_ipv6_addr_lookup_by_index(const struct in6_addr *addr)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke1(*(uintptr_t *)&addr,
						 K_SYSCALL_NET_IF_IPV6_ADDR_LOOKUP_BY_INDEX);
	}
#endif
	compiler_barrier();
...
extern bool z_impl_net_if_ipv6_addr_add_by_index(int index, struct in6_addr *addr,
						 enum net_addr_type addr_type, uint32_t vlifetime);
static inline bool net_if_ipv6_addr_add_by_index(int index, struct in6_addr *addr,
						 enum net_addr_type addr_type, uint32_t vlifetime)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (bool)arch_syscall_invoke4(*(uintptr_t *)&index, *(uintptr_t *)&addr,
						  *(uintptr_t *)&addr_type,
						  *(uintptr_t *)&vlifetime,
						  K_SYSCALL_NET_IF_IPV6_ADDR_ADD_BY_INDEX);
	}
#endif
	compiler_barrier();
...
static inline bool net_if_ipv6_addr_rm_by_index(int index, const struct in6_addr *addr)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (bool)arch_syscall_invoke2(*(uintptr_t *)&index, *(uintptr_t *)&addr,
						  K_SYSCALL_NET_IF_IPV6_ADDR_RM_BY_INDEX);
	}
#endif
	compiler_barrier();
...
static inline int net_if_ipv4_addr_lookup_by_index(const struct in_addr *addr)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke1(*(uintptr_t *)&addr,
						 K_SYSCALL_NET_IF_IPV4_ADDR_LOOKUP_BY_INDEX);
	}
#endif
	compiler_barrier();
...
extern bool z_impl_net_if_ipv4_addr_add_by_index(int index, struct in_addr *addr,
						 enum net_addr_type addr_type, uint32_t vlifetime);
static inline bool net_if_ipv4_addr_add_by_index(int index, struct in_addr *addr,
						 enum net_addr_type addr_type, uint32_t vlifetime)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		...
		return (bool)arch_syscall_invoke4(*(uintptr_t *)&index, *(uintptr_t *)&addr,
						  *(uintptr_t *)&addr_type,
						  *(uintptr_t *)&vlifetime,
						  K_SYSCALL_NET_IF_IPV4_ADDR_ADD_BY_INDEX);
	}
#endif
	compiler_barrier();
...
static inline bool net_if_ipv4_set_netmask_by_index(int index, const struct in_addr *netmask)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (bool)arch_syscall_invoke2(*(uintptr_t *)&index, *(uintptr_t *)&netmask,
...
static inline bool net_if_ipv4_set_gw_by_index(int index, const struct in_addr *gw)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (bool)arch_syscall_invoke2(*(uintptr_t *)&index, *(uintptr_t *)&gw,
...
static inline struct net_if *net_if_get_by_index(int index)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (struct net_if *)arch_syscall_invoke1(*(uintptr_t *)&index,
							     K_SYSCALL_NET_IF_GET_BY_INDEX);
	}
#endif
	compiler_barrier();
