...
static inline void *zsock_get_context_object(int sock)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (void *)arch_syscall_invoke1(*(uintptr_t *)&sock,
						    K_SYSCALL_ZSOCK_GET_CONTEXT_OBJECT);
	}
#endif
	compiler_barrier();
...
static inline int zsock_socket(int family, int type, int proto)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&family, *(uintptr_t *)&type,
						 *(uintptr_t *)&proto, K_SYSCALL_ZSOCK_SOCKET);
	}
#endif
	compiler_barrier();
...
static inline int zsock_socketpair(int family, int type, int proto, int *sv)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke4(*(uintptr_t *)&family, *(uintptr_t *)&type,
						 *(uintptr_t *)&proto, *(uintptr_t *)&sv,
...
static inline int zsock_shutdown(int sock, int how)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&sock, *(uintptr_t *)&how,
						 K_SYSCALL_ZSOCK_SHUTDOWN);
	}
#endif
	compiler_barrier();
...
static inline int zsock_bind(int sock, const struct sockaddr *addr, socklen_t addrlen)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&sock, *(uintptr_t *)&addr,
						 *(uintptr_t *)&addrlen, K_SYSCALL_ZSOCK_BIND);
	}
#endif
	compiler_barrier();
...
static inline int zsock_connect(int sock, const struct sockaddr *addr, socklen_t addrlen)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&sock, *(uintptr_t *)&addr,
						 *(uintptr_t *)&addrlen, K_SYSCALL_ZSOCK_CONNECT);
	}
#endif
	compiler_barrier();
...
static inline int zsock_listen(int sock, int backlog)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&sock, *(uintptr_t *)&backlog,
						 K_SYSCALL_ZSOCK_LISTEN);
	}
#endif
	compiler_barrier();
...
static inline int zsock_accept(int sock, struct sockaddr *addr, socklen_t *addrlen)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&sock, *(uintptr_t *)&addr,
						 *(uintptr_t *)&addrlen, K_SYSCALL_ZSOCK_ACCEPT);
	}
#endif
	compiler_barrier();
...
extern ssize_t z_impl_zsock_sendto(int sock, const void *buf, size_t len, int flags,
				   const struct sockaddr *dest_addr, socklen_t addrlen);
static inline ssize_t zsock_sendto(int sock, const void *buf, size_t len, int flags,
				   const struct sockaddr *dest_addr, socklen_t addrlen)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (ssize_t)arch_syscall_invoke6(*(uintptr_t *)&sock, *(uintptr_t *)&buf,
...
static inline ssize_t zsock_sendmsg(int sock, const struct msghdr *msg, int flags)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (ssize_t)arch_syscall_invoke3(*(uintptr_t *)&sock, *(uintptr_t *)&msg,
						     *(uintptr_t *)&flags, K_SYSCALL_ZSOCK_SENDMSG);
	}
#endif
	compiler_barrier();
...
extern ssize_t z_impl_zsock_recvfrom(int sock, void *buf, size_t max_len, int flags,
				     struct sockaddr *src_addr, socklen_t *addrlen);
static inline ssize_t zsock_recvfrom(int sock, void *buf, size_t max_len, int flags,
				     struct sockaddr *src_addr, socklen_t *addrlen)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (ssize_t)arch_syscall_invoke6(*(uintptr_t *)&sock, *(uintptr_t *)&buf,
						     *(uintptr_t *)&max_len, *(uintptr_t *)&flags,
						     *(uintptr_t *)&src_addr,
						     *(uintptr_t *)&addrlen,
						     K_SYSCALL_ZSOCK_RECVFROM);
	}
#endif
	compiler_barrier();
...
static inline int zsock_fcntl(int sock, int cmd, int flags)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&sock, *(uintptr_t *)&cmd,
						 *(uintptr_t *)&flags, K_SYSCALL_ZSOCK_FCNTL);
	}
#endif
	compiler_barrier();
...
static inline int zsock_poll(struct zsock_pollfd *fds, int nfds, int timeout)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&fds, *(uintptr_t *)&nfds,
						 *(uintptr_t *)&timeout, K_SYSCALL_ZSOCK_POLL);
	}
#endif
	compiler_barrier();
...
extern int z_impl_zsock_getsockopt(int sock, int level, int optname, void *optval,
				   socklen_t *optlen);
static inline int zsock_getsockopt(int sock, int level, int optname, void *optval,
				   socklen_t *optlen)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke5(*(uintptr_t *)&sock, *(uintptr_t *)&level,
						 *(uintptr_t *)&optname, *(uintptr_t *)&optval,
						 *(uintptr_t *)&optlen, K_SYSCALL_ZSOCK_GETSOCKOPT);
	}
#endif
	compiler_barrier();
...
extern int z_impl_zsock_setsockopt(int sock, int level, int optname, const void *optval,
				   socklen_t optlen);
static inline int zsock_setsockopt(int sock, int level, int optname, const void *optval,
				   socklen_t optlen)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		...
		return (int)arch_syscall_invoke5(*(uintptr_t *)&sock, *(uintptr_t *)&level,
						 *(uintptr_t *)&optname, *(uintptr_t *)&optval,
						 *(uintptr_t *)&optlen, K_SYSCALL_ZSOCK_SETSOCKOPT);
	}
#endif
	compiler_barrier();
...
static inline int zsock_gethostname(char *buf, size_t len)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke2(*(uintptr_t *)&buf, *(uintptr_t *)&len,
						 K_SYSCALL_ZSOCK_GETHOSTNAME);
	}
#endif
	compiler_barrier();
...
static inline int zsock_inet_pton(sa_family_t family, const char *src, void *dst)
{
	...
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke3(*(uintptr_t *)&family, *(uintptr_t *)&src,
						 *(uintptr_t *)&dst, K_SYSCALL_ZSOCK_INET_PTON);
	}
#endif
	compiler_barrier();
...
extern int z_impl_z_zsock_getaddrinfo_internal(const char *host, const char *service,
					       const struct zsock_addrinfo *hints,
					       struct zsock_addrinfo *res);
static inline int z_zsock_getaddrinfo_internal(const char *host, const char *service,
					       const struct zsock_addrinfo *hints,
					       struct zsock_addrinfo *res)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		/* coverity[OVERRUN] */
		return (int)arch_syscall_invoke4(*(uintptr_t *)&host, *(uintptr_t *)&service,
						 *(uintptr_t *)&hints, *(uintptr_t *)&res,
