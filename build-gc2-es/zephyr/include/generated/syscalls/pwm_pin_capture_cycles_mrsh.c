...
extern int z_vrfy_pwm_pin_capture_cycles(const struct device *dev, uint32_t pwm, pwm_flags_t flags,
					...
					uintptr_t arg3, uintptr_t arg4, void *more, void *ssf)
{
	...
	int ret = z_vrfy_pwm_pin_capture_cycles(*(const struct device **)&arg0, *(uint32_t *)&arg1,
						*(pwm_flags_t *)&arg2, *(uint32_t **)&arg3,
						*(uint32_t **)&arg4, parm0.val);
